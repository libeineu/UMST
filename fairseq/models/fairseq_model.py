...
class FairseqTreeModel1(BaseFairseqModel):
    def __init__(self, encoder,decoder):
        super().__init__()
        self.encoder = encoder
        self.decoder = decoder
        ...
        #assert isinstance(self.decoder, FairseqDecoder)
        #print(1)
    def forward(self, src_tokens, src_lengths, tree, orign_tree, mapping, prev_output_tokens):
        encoder_out = self.encoder(src_tokens, src_lengths, tree, orign_tree, mapping)
...
class FairseqPhraseModel(BaseFairseqModel):
    def __init__(self, encoder,decoder):
        super().__init__()
        self.encoder = encoder
        self.decoder = decoder
        ...
        #assert isinstance(self.decoder, FairseqDecoder)
        #print(1)
    def forward(self, src_tokens, src_lengths, tree, bpe2word_scale, bpe2word_wo_scale, phrase_mapping, prev_output_tokens):
        encoder_out = self.encoder(src_tokens, src_lengths, tree, bpe2word_scale, bpe2word_wo_scale, phrase_mapping)
        decoder_out = self.decoder(prev_output_tokens, encoder_out)
        return decoder_out
    def max_positions(self):
        return self.decoder.max_positions()
...
class FairseqLocalPhraseModel(BaseFairseqModel):
    def __init__(self, encoder,decoder):
        super().__init__()
        self.encoder = encoder
        self.decoder = decoder
        ...
        #assert isinstance(self.decoder, FairseqDecoder)
        #print(1)
    def forward(self, src_tokens, src_lengths, tree, bpe2word_scale, bpe2word_wo_scale, phrase_mapping, local_mapping, prev_output_tokens):
        encoder_out = self.encoder(src_tokens, src_lengths, tree, bpe2word_scale, bpe2word_wo_scale, phrase_mapping, local_mapping)
        decoder_out = self.decoder(prev_output_tokens, encoder_out)
        return decoder_out
    def max_positions(self):
        return self.decoder.max_positions()
